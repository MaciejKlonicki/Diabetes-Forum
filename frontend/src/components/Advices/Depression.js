    ...
    return (
        <div className='border-living'>
            ...
            <p className='p-how-to'>
                ...
                Fobia społeczna, czyli lęk przed ludźmi, wiąże się z unikaniem sytuacji społecznych. Połączony jest z niskim poczuciem własnej wartości i przeświadczeniem o nieprzystosowaniu. U osób z cukrzycą typu II. <br/><br/>
                Zachowania nerwicowe: zbyt częste pomiary stężenia glukozy lub unikanie pomiarów, lęk czy wkłucie pompy insulinowej było odpowiednie, złe interpretacje wyników, obsesyjne myśli, potrzeba ciągłej kontroli i perfekcjonizm. <br/><br/>
                Depresja – może być i skutkiem, i przyczyną cukrzycy. Zwiększa dwukrotnie ryzyko zachorowania na cukrzycę typu II. Choruje na nią ok. 30% cukrzyków. Depresja powoduje, że chorzy mają większe problemy z kontrolą choroby, stosowaniem się do zaleceń dotyczących diety i trybu życia.<br/><br/>
            </p>
        </div>
    )
}
